...
from rdkit.Chem import AllChem, Descriptors, Crippen, Lipinski, rdfiltercatalog
...
params_pain = rdfiltercatalog.FilterCatalogParams()
params_pain.AddCatalog(rdfiltercatalog.FilterCatalogParams.FilterCatalogs.PAINS_A)
catalog_pain = rdfiltercatalog.FilterCatalog(params_pain)
