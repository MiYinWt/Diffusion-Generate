...
if __name__ == '__main__':
    # Useage: python ./datas/data_preparation/extract_pockets.py --source ./datas/PDBbind_v2020/source --dest ./datas/PDBbind_v2020/PDBbind_v2020_pocket10  --radius 10
    parser = argparse.ArgumentParser()
    parser.add_argument('--source', type=str, default='./datas/PDBbind_v2020/source')
